  ...
  return (
    <div className="presentation-container" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <section className="hero" style={{ maxWidth: '1100px', margin: '40px auto 20px', padding: '0 20px', textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '3rem', lineHeight: 1.15, marginBottom: '20px', color: 'var(--primary-900)', letterSpacing: '-0.02em' }}>
          {t.hero.title}<br />
          <span style={{
        ...
        <p style={{ fontSize: '1.15rem', maxWidth: '740px', margin: '0 auto 32px', color: 'var(--text-muted)', lineHeight: 1.7 }}>
          {t.hero.description}
        </p>
      ...
      <section className="features-section" style={{ maxWidth: '1100px', margin: '30px auto', padding: '0 20px' }}>
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <h2 className="section-title" style={{ fontSize: '2.1rem', color: 'var(--primary-900)', marginBottom: '14px' }}>
            {t.purpose.title}
          </h2>
        ...
        <div className="features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '22px' }}>
          <div className="feature-card">
            <div className="feature-icon"><Camera size={24} style={{ color: '#10b981' }} /></div>
            <h3>{t.purpose.card1Title}</h3>
            <p>{t.purpose.card1Desc}</p>
          </div>

          <div className="feature-card">
            <div className="feature-icon"><Scissors size={24} style={{ color: '#10b981' }} /></div>
            <h3>{t.purpose.card2Title}</h3>
            <p>{t.purpose.card2Desc}</p>
          </div>

          <div className="feature-card">
            <div className="feature-icon"><Droplets size={24} style={{ color: '#10b981' }} /></div>
            <h3>{t.purpose.card3Title}</h3>
            <p>{t.purpose.card3Desc}</p>
          </div>

          <div className="feature-card">
            <div className="feature-icon"><Sun size={24} style={{ color: '#10b981' }} /></div>
            <h3>{t.purpose.card4Title}</h3>
            <p>{t.purpose.card4Desc}</p>
          </div>

          <div className="feature-card">
            <div className="feature-icon"><WifiOff size={24} style={{ color: '#10b981' }} /></div>
            <h3>{t.purpose.card5Title}</h3>
            <p>{t.purpose.card5Desc}</p>
          </div>

          <div className="feature-card">
            <div className="feature-icon"><Zap size={24} style={{ color: '#10b981' }} /></div>
      ...
      <section className="guide-section" style={{ maxWidth: '1100px', margin: '40px auto', padding: '0 20px' }}>
        <div className="guide-card" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '10px' }}>
            ...
            <h2 style={{ fontSize: '1.85rem', color: 'var(--primary-900)' }}>{t.install.title}</h2>
          </div>
          ...
          <div className="steps-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
            <div className="step-item" style={{ background: 'var(--surface)', padding: '22px', borderRadius: '14px', border: '1px solid var(--border-color)' }}>
              <h4 style={{ color: 'var(--primary-600)', fontSize: '1.1rem', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span>{t.install.androidTitle}</span>
              </h4>
              <p style={{ color: 'var(--text-main)', fontSize: '0.92rem', lineHeight: 1.6, marginBottom: '6px' }}>{t.install.androidStep1}</p>
              <p style={{ color: 'var(--text-main)', fontSize: '0.92rem', lineHeight: 1.6, marginBottom: '6px' }}>{t.install.androidStep2}</p>
              <p style={{ color: 'var(--text-main)', fontSize: '0.92rem', lineHeight: 1.6 }}>{t.install.androidStep3}</p>
            </div>
            ...
            <div className="step-item" style={{ background: 'var(--surface)', padding: '22px', borderRadius: '14px', border: '1px solid var(--border-color)' }}>
              ...
              <p style={{ color: 'var(--text-main)', fontSize: '0.92rem', lineHeight: 1.6, marginBottom: '6px' }}>{t.install.iosStep1}</p>
              <p style={{ color: 'var(--text-main)', fontSize: '0.92rem', lineHeight: 1.6, marginBottom: '6px' }}>{t.install.iosStep2}</p>
              <p style={{ color: 'var(--text-main)', fontSize: '0.92rem', lineHeight: 1.6 }}>{t.install.iosStep3}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer Credits */}
      <footer style={{ marginTop: 'auto', borderTop: '1px solid var(--border-color)', background: 'var(--surface-glass)', padding: '36px 20px', textAlign: 'center' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '14px' }}>
          <h4 style={{ color: 'var(--primary-900)', fontSize: '1.1rem' }}>{t.credits.title}</h4>
